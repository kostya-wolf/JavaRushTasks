...
public class Solution {
    ...
    public static void main(String[] args) {
        OutputToConsole apartment = new OutputToConsole(5);
        apartment.printMessage();
        try {
            ...
            OutputToConsole apartment2 = (OutputToConsole) inputStream.readObject();
            apartment2.printMessage();
