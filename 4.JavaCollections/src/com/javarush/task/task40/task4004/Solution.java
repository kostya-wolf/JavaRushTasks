...
public class Solution {
    ...
    // Используя класс java.awt.Polygon
    private static boolean isPointInPolygon2(Point point, List<Point> polygon) {
        Polygon pol = new Polygon();
        polygon.forEach(p -> pol.addPoint(p.x, p.y));
        return pol.contains(new java.awt.Point(point.x, point.y));
    }
}
